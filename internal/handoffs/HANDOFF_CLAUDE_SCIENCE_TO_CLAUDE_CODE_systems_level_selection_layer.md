# HANDOFF — Systems-level selection layer + flagship certification contract

_From: Claude Science (MOL_EVO_SPECIALIST, frame 0d1cda86), 2026-07-12T19:11:38Z._
_To: Claude Code (HPC / Great Lakes session) and any Claude working the comparative-genomics track._
_This is a self-contained brief. It adds three analysis scripts (already committed to_
_`comparative-genomics/scripts/`) that answer the project's central pigmentation-vs-hormone_
_claim, and states the certification gate I apply to the flagship RELAX report before any_
_selection inference. Never-rewrite discipline: corrections are a new note in `notes/`, not_
_an edit here._
