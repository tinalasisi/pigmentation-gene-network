...
| 11 | **STRING v12.0** (protein–protein associations) | Human (taxon 9606) functional-association edges among the sex-hormone/pigmentation panel, `combined_score ≥ 0.4`; 132 edges backing the module-selection interactive view (`comparative-genomics/analysis/module_selection/data/string_diff_edges.tsv`) | STRING API pull (`string-db.org`, v12.0), score threshold 0.4; **CC BY 4.0** (same license as the D'Arcy STRING tables in entry 7) | ✅ committed (CC BY 4.0); redistribution open | (module-selection interactive substrate; see `comparative-genomics/analysis/module_selection/INTERACTIVE_SPEC_README.md`) |
| 12 | **KEGG pathways hsa00140 + hsa04912** (sex-hormone gene panel) | The 53-gene hormone module (`comparative-genomics/analysis/data/hormone_axes.csv`): 27 genes seeded from **Steroid hormone biosynthesis (hsa00140)** + 8 from **GnRH signaling (hsa04912)**, plus 18 design-added androgen/estrogen receptor→target genes (AR, ESR1/2, GPER1, FSHR, LHCGR) and steroid-signaling cofactors/carriers (NCOA1/2/3, NCOR1/2, SHBG, FKBP5, SCARB1, LDLR, STAR, KISS1/1R), then annotated into 6 functional axes | `rest.kegg.jp` pathway membership (hsa00140, hsa04912); receptor/cofactor genes added per NB13 design; verified 2026-07-13 (27∩hsa00140, 8∩hsa04912) | ✅ committed; KEGG academic-use terms (membership facts only, no pathway maps redistributed) | (assembled in Notebook 13; provenance manifest in NB13/NB14 `INPUTS`) |
...
- **Identity:** *Genome Res* 28(11):1621–1635 (2018); DOI 10.1101/gr.233304.117; **PMID 30333196**
  (PMID↔DOI verified against NCBI eutils esummary, db=pubmed id=30333196: returns title
  "Cell-type-specific eQTL of primary melanocytes facilitates identification of melanoma susceptibility
  genes.", Genome Res 28:1621-1635, authors Zhang T/Choi J/Kovacs MA/Shi J, doi 10.1101/gr.233304.117).
  Brown lab (NCI DCEG); Pavan co-author.
