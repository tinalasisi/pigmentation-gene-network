...
- **A phylogeny-controlled cross-species association scan finds one suggestive gene.** Treating the
  ...
  (*p* ≈ 0.04) but not under the more appropriate binary model, phyloglm (*p*_BH = 1.0). Since PGLS
  is an anticonservative linear-probability model, this is a **single suggestive candidate**, not an
  established locus: one hit among ~90 genes with only ~24 cases, and the binding constraint is the
