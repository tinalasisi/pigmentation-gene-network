...
reachable through the coupled **pigmentation × sex-hormone** network rather than one canonical
switch. Whether the *same* or *different* parts of that network are recruited across origins — a
...
| architecture across origins | a shared switch | polygenic; shared-vs-heterogeneous **underpowered to resolve** (χ² p = 0.42) |
